...
from pydevmgr_elt_qt import ShutterLine, EltManagerLinker
...
motor1: # Focus on motor1 as an exemple 
    ...
    setup:
        - device: motor1              
          widget_kind: "ctrl" # all devices in one line control widget 
    setup:
        - device: "motor1"
          widget_kind: "ctrl"   
...
if __name__=="__main__":
    ...
    ml = EltManagerLinker(views=layout_conf, link_failure=True)
    data = ml.new_data(current_view="main")
